...
import com.publictransitanalytics.scoregenerator.testhelpers.PreloadedEntryPoints;
 ...
 */
public class ForwardScheduleReaderTest {
...
//
//        final EntryPoints entryPoints = new PreloadedEntryPoints();
//
...
//        final ForwardRider rider = new ForwardRider(
//                STOP_ON_TRIP, schedule,
//                LocalDateTime.of(2017, Month.FEBRUARY, 12, 10, 25, 0));
//        final Set<RiderStatus> trips = rider.getEntryPoints(
//                LocalDateTime.of(2017, Month.FEBRUARY, 12, 10, 15, 0));
